/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2a43870a42007e96240791bd5ad4227d)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		MULTIPART_UPLOADS_KV: KVNamespace;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		AWS_DEFAULT_REGION: "us-west-000";
		AWS_ENDPOINT: "https://fotoowl-dev-bucket-1.s3.us-west-000.backblazeb2.com";
		AWS_S3_BUCKET: "fotoowl-dev-bucket-1";
		API_HOST: "https://dev-api.fotoowl.ai";
		API_USERNAME: "eece118d-83b7-4593-9b5a-481e64cd558d";
		DOCS_USERNAME: "fotoowl";
		SENTRY_DSN: "https://348f1cb31d3031c537e128d312859f9f@o4511415367434240.ingest.us.sentry.io/4511420593537024";
		ENV: "dev";
	...
	interface StagingEnv {
		...
		AWS_ENDPOINT: "https://fotoowl-dev-bucket-1.s3.us-west-000.backblazeb2.com";
		AWS_S3_BUCKET: "fotoowl-dev-bucket-1";
		API_HOST: "https://staging-jiraya-v2.fotoowl.ai";
		API_USERNAME: "eece118d-83b7-4593-9b5a-481e64cd558d";
		DOCS_USERNAME: "fotoowl";
		SENTRY_DSN: "https://348f1cb31d3031c537e128d312859f9f@o4511415367434240.ingest.us.sentry.io/4511420593537024";
		ENV: "staging";
		OTEL_EXPORTER_OTLP_TRACES_ENDPOINT: "https://otel-staging.fotoowl.ai/v1/traces";
		OTEL_EXPORTER_OTLP_LOGS_ENDPOINT: "https://otel-staging.fotoowl.ai/v1/logs";
		OTEL_SERVICE_NAME: "upload-worker";
		APP_OTEL_DEBUG: "true";
	...
	interface Env {
		...
		AWS_ENDPOINT?: "https://fotoowl-dev-bucket-1.s3.us-west-000.backblazeb2.com" | "";
		AWS_S3_BUCKET?: "fotoowl-dev-bucket-1" | "";
		API_HOST?: "https://dev-api.fotoowl.ai" | "https://staging-jiraya-v2.fotoowl.ai" | "";
		API_USERNAME?: "eece118d-83b7-4593-9b5a-481e64cd558d" | "";
		DOCS_USERNAME?: "fotoowl" | "";
		SENTRY_DSN?: "https://348f1cb31d3031c537e128d312859f9f@o4511415367434240.ingest.us.sentry.io/4511420593537024" | "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AWS_DEFAULT_REGION" | "AWS_ENDPOINT" | "AWS_S3_BUCKET" | "API_HOST" | "API_USERNAME" | "DOCS_USERNAME" | "SENTRY_DSN" | "ENV" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "API_PASSWORD" | "DOCS_PASSWORD" | "OTEL_EXPORTER_OTLP_TRACES_ENDPOINT" | "OTEL_EXPORTER_OTLP_LOGS_ENDPOINT" | "OTEL_SERVICE_NAME" | "APP_OTEL_DEBUG" | "OTEL_DISABLE_TRACES">> {}
}
